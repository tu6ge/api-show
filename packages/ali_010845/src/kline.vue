            ...
            return {
                ...
                series: [
                    ...
                    },
                    {
                        name: 'MA5',
                        type: 'line',
                        data: this.calculateMA(5, this.data_list),
                        smooth: true,
                        showSymbol: false,
                        lineStyle: {
                            normal: {
                    ...
                    },
                    {
                        name: 'MA10',
                        type: 'line',
                        data: this.calculateMA(10, this.data_list),
                        smooth: true,
                        showSymbol: false,
                        lineStyle: {
                            normal: {
                    ...
                    },
                    {
                        name: 'MA20',
                        type: 'line',
                        data: this.calculateMA(20, this.data_list),
                        smooth: true,
                        showSymbol: false,
                        lineStyle: {
                            normal: {
                    ...
                    },
                    {
                        name: 'MA30',
                        type: 'line',
                        data: this.calculateMA(30, this.data_list),
                        smooth: true,
                        showSymbol: false,
                        lineStyle: {
                            normal: {
